...
# Define the mesh
##################################
# mesh cells per direction. Has to be a 2^n power
nx = 64 
ny = 64
nz = 128
...
t_offs = -5.332370636221942e-10 - 9*dz/picmi.constants.c   #like CST (-160 mm) + non-vacuum cells from injection point
