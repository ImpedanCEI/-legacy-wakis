...
OUT_PATH = '/mnt/c/Users/elefu/Documents/CERN/GitHub/PyWake/Scripts/WarpX/'
...
def plot_PyWake(out_path, cst_data=read_CST_out(CST_PATH), flag_compare_cst=True, flag_normalize=True):
    # Read wake solver output
    data=read_PyWake_out(out_path)
    # Plot results
