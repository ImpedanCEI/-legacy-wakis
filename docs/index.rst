...
Wakis is a postprocessing package that computes the Wake Potential and Impedance from pre-computed fields. These are important parameters to asses the losses of accelerator structures with a passing beam. 
